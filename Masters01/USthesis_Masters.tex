...
\include{frontmatter/Acronyms-Declarations}
...
\include{contents/Literature-Review}
\include{contents/Conceptualisation-and-Modelling}
\include{contents/System-Overview}
\include{contents/Chap-3}
\include{contents/Divide-Areas-Algorithm}
\include{contents/Subregion-Coverage}
\include{contents/Dynamic-Constraints}
\include{contents/Refuelling-Protocol}
